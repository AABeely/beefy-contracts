...
const config = {
  vault: "0x8e821f4DD2ca6660A63875DF9f7B35Db83D42dBF",
  vaultContract: "BeefyVaultV6",
  strategyContract: "StrategyPolygonQuickLP",
  ...
  keeper: secondAddress,
  strategyOwner: myAddress,
  vaultOwner: myAddress,
};
...
describe("VaultLifecycleTest", () => {
  ...
  it.only("Manager can panic.", async () => {
    await unpauseIfPaused(strategy, keeper);
