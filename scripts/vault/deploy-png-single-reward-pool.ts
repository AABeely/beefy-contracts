...
const rewardPool = web3.utils.toChecksumAddress("0x88afdaE1a9F58Da3E68584421937E5F564A0135b");
// const lp = web3.utils.toChecksumAddress("0x71952D09Aa093aCCCAe0c1d5612D7FE26F20517f");

const vaultParams = {
  mooName: "Moo PangolinV2 PNG",
  mooSymbol: "mooPangolinV2PNG",
  delay: 21600,
};
...
const strategyParams = {
  ...
  outputToWantRoute: [PNG],
};

const contractNames = {
  vault: "BeefyVaultV6",
  strategy: "StrategyCommonRewardPoolSingle",
};
